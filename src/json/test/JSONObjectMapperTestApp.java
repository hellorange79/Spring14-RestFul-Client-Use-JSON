...
public class JSONObjectMapperTestApp {
	...
	public static void main(String[] args) throws Exception	{
		...
		System.out.println("2.JSON Value=> List<User> 변환 및 값 추출");
		...
		System.out.println("3.Map<User> => JSON Value 변환 ");
		...
		System.out.println("3. JSON Value(String -> Map<User>로 변환및 값 추출)");
		...
		System.out.println("2. JSON Value =>");
